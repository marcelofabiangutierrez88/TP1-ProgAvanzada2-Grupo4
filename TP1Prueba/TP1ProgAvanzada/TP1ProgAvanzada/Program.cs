...
namespace TP1ProgAvanzada
{
    public class Program
    {
        ...
        public static String cutString(String a)
        {
            ...
            String resultado = myString.Remove(4, 4);

            Console.WriteLine("Cadena cortada: " + resultado);
        ...
        public static int Enumeracion2()
        {
        ...
        public static bool ejercicio1(bool b)
        {
            b = true;
            b = bool.Parse("FALSE");
            ...
            bool myBool = Convert.ToBoolean(b);
        ...
        public static String ejercicio4(int c)
        {
        ...
        public static String ejercicio5(int d)
        {
